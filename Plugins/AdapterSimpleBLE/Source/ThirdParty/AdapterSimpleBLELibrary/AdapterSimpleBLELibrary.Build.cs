...
public class AdapterSimpleBLELibrary : ModuleRules
{
	public AdapterSimpleBLELibrary(ReadOnlyTargetRules Target) : base(Target)
	{
		...
		if (Target.Platform == UnrealTargetPlatform.Win64)
		{
			...
			RuntimeDependencies.Add("$(PluginDir)/Binaries/ThirdParty/AdapterSimpleBLELibrary/Win64/ExampleLibrary.dll");
        }
